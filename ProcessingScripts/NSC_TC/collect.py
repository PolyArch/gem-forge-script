...
def getConfigurations(subset):
    ...
    trans_valid = 'valid.ex'
    sim_valid_o8 = 'base.ruby.uno.o8.8x8c-l256-s64B-ch64B'
    sim_valid_o8_bingo = 'base.ruby.uno.o8.8x8c-l256-s64B-ch64B.bingo-l2pf16'

    trans_ssp = 'stream.ex.static.so.store'
    sim_ssp_o8 = 'ss.ruby.uno.o8.8x8c-l256-s64B-ch64B.f2048-c-gb'
    sim_sf_o8 = 'ss.ruby.uno.o8.8x8c-l256-s1kB-ch4kB.f2048-c-gb.flts-mc2'

    trans_nsc = 'stream.ex.static.so.store.cmp'
    sim_sync_o8 = 'ss.ruby.uno.o8.8x8c-l256-s1kB-ch4kB.f2048-c-gb.fltsc-cmp-sync'
    sim_cmp_o8 = 'ss.ruby.uno.o8.8x8c-l256-s1kB-ch4kB.f2048-c-gb.fltsc-cmp'

    trans_free = 'stream.ex.static.so.store.cmp-bnd-elim-nst'
    sim_rmt_o8 = 'ss.ruby.uno.o8.8x8c-l256-c4-s1kB-ch4kB.f2048x256-c-gb-o3end-nest4.fltsc-cmp-mif8-snuca1-rmt-strand0-ind0-b0.2-csr1-iacer0x0x0x0x0'
    sim_free_o8 = 'ss.ruby.uno.o8.8x8c-l256-c4-s1kB-ch4kB.f2048x256-c-gb-o3end-nest4.fltsc-cmp-mif8-snuca1-strand0-ind0-b0.2-csr1-iacer0x0x0x0x0'
    ...
    if subset in ['overall']:
        ...
        for suite, benchmark, tdg_folder in [
            ...
            ('gfm',     'omp_dwt2d53_avx',            f'fake.0.tdg.large.thread64'),
            ('gfm',     'omp_histogram_avx',          f'fake.0.tdg.large.thread64'),
            ('rodinia', 'streamcluster',              f'fake.0.tdg.large-thread64'),
            ('mine',    'svm',                        f'fake.0.tdg.large-thread64'),
            ('gap',     'pr_push',                    f'fake.0.tdg.krn18-k16.thread64'),
            ('gap',     'pr_pull_shuffle',            f'fake.0.tdg.krn18-k16.thread64'),
            ('gap',     'bfs_push',                   f'fake.0.tdg.krn18-k16.thread64'),
            ('gap',     'bfs_pull_shuffle_nobrk',     f'fake.0.tdg.krn18-k16.thread64'),
            ('gap',     'sssp',                       f'fake.0.tdg.krn18-k16.thread64'),
            ('gfm',     'omp_binary_tree',            f'fake.0.tdg.large.thread64'),
            ('gfm',     'omp_hash_join',              f'fake.0.tdg.large.thread64'),
        ]:
            rename_tdg_folder = f'large.thread64'
            rename_benchmark = benchmark
            # Valid and SSP/SF pick check version for bfs_push and sssp
            if benchmark == 'bfs_push' or benchmark == 'sssp':
                benchmark_check = f'{benchmark}_check'
            else:
                benchmark_check = benchmark
            configurations.append({
                'suite': suite,
                'benchmark': (benchmark_check, rename_benchmark),
            ...
            # NSC pick non-check version for bfs_push and sssp.
            configurations.append({
                'suite': suite,
            ...
            # NSC free picks bfs_push_sf and sssp_sf_delta1
            if rename_benchmark == 'bfs_push':
                benchmark = 'bfs_push_sf'
            elif rename_benchmark == 'sssp':
                benchmark = 'sssp_sf_delta1'
            configurations.append({
                'suite': suite,
                'benchmark': (benchmark, rename_benchmark),
                'tdg_folder': (tdg_folder, rename_tdg_folder),
