...
# SimInput+=',medium.aff-min-hops'
# SimInput+=',medium.aff-min-load'
# SimInput+=',medium.aff-random'
# SimInput+=',medium.aff-hybrid'
# SimInput+=',medium.aff-delta'
# SimInput+=',small.aff-min-hops'
# SimInput+=',small.aff-min-load'
# SimInput+=',small.aff-random'
# SimInput+=',small.aff-hybrid'
# SimInput+=',small.aff-delta'
